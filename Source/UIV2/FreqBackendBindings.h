...
{
class FreqBackendBindings final : public SimpleUIV2::SimpleJuceBackend,
                                  public Modulation::UI::ModulationUiBackend
{
public:
    explicit FreqBackendBindings(FREQTRAudioProcessor& processorToUse) noexcept;
    ~FreqBackendBindings() override;
...
private:
    FREQTRAudioProcessor& processor;
    int preparedMaxWindow = -1;
    FREQTRAudioProcessor::CarrierTopologyTelemetry carrierTelemetry;
    FREQTRAudioProcessor::WetTelemetrySnapshot wetTelemetrySnapshot;
